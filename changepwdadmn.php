...
<body>    
     <div class="container">
         <a href="admin.php"><div class="card-panel blue darken-1 hoverable"> <font color='white'> Administrator</font></div></a>    
     </div>

     <div class="container">      
    <div align="center" class="card-panel hoverable">
      <div class="container">
         <div class="card-panel blue darken-3 hoverable hoverable"> <font color='white'>Change your Administrator Password</font></div>  
      </div>   

     
        <form class="col s12" method="POST" action="chpwdadmn.php">
            <div class="row">
            ...
            <button class="btn waves-effect waves" type="submit" name="action" onclick="Materialize.toast('<p><?php echo $_GET['status']; ?></p>', 150000)">Update
